    ...
    while (!encerrar) {
        ...
        switch (opcao) {
            case '1':
                ...
                conta.depositar(valorDeposito); // Testa a funcionalidade de depósito [cite: 131]
                break;
            case '2':
            ...
            case '3':
                ...
                const rendimento = conta.calcularRendimento(); // Testa o cálculo de rendimento [cite: 132]
                console.log(`Rendimento mensal projetado: R$ ${rendimento.toFixed(2)}`);
                break;
            case '4':
                conta.imprimirInfo(); // Imprime informações sobre a conta [cite: 134]
                break;
            case '5':
                encerrar = true;
